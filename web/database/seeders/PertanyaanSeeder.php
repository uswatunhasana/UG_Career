...
class PertanyaanSeeder extends Seeder
{
    public function run()
    {
            $array=[
                ...
                ['jenis_pertanyaan' => 'pilihan','kategori_pertanyaan' => 'alumni', 'kelas_pertanyaan' => 'wajib', 'is_cabang' => 'tidak', 'kd_pertanyaan' => 'F1A', 'pertanyaan' => 'Apakah anda bekerja saat ini (termasuk kerja sambilan dan wirausaha)?', 'created_at' => now(), 'updated_at' => now()],
                ['jenis_pertanyaan' => 'pilihan','kategori_pertanyaan' => 'alumni', 'kelas_pertanyaan' => 'wajib', 'is_cabang' => 'tidak', 'kd_pertanyaan' => 'F1B', 'pertanyaan' => 'Tempat anda bekerja saat ini bergerak di bidang apa?', 'created_at' => now(), 'updated_at' => now()],
                ['jenis_pertanyaan' => 'pilihan','kategori_pertanyaan' => 'alumni', 'kelas_pertanyaan' => 'wajib', 'is_cabang' => 'tidak', 'kd_pertanyaan' => 'F1C', 'pertanyaan' => 'Berdasarkan pengalaman pada pekerjaan Anda  saat ini,  apa saran yang anda berikan  untuk peningkatan kualitas pembelajaran di Universitas Gunadarma?', 'created_at' => now(), 'updated_at' => now()],
                ...
                ['jenis_pertanyaan' => 'pilihan','kategori_pertanyaan' => 'alumni', 'kelas_pertanyaan' => 'wajib', 'is_cabang' => 'tidak', 'kd_pertanyaan' => 'F1D', 'pertanyaan' => 'Jabatan anda pada waktu pertama bekerja', 'created_at' => now(), 'updated_at' => now()],
                ['jenis_pertanyaan' => 'pilihan','kategori_pertanyaan' => 'alumni', 'kelas_pertanyaan' => 'wajib', 'is_cabang' => 'tidak', 'kd_pertanyaan' => 'F1E', 'pertanyaan' => 'Tingkat kesesuaian antara Prodi asal saudara dengan pekerjaan yang saudara tekuni saat ini', 'created_at' => now(), 'updated_at' => now()],
