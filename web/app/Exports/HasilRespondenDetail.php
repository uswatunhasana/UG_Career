...
class HasilRespondenDetail implements FromView
{
    ...
    {
        $jawabanrespondens = Jawabanresponden::with(['user','jawabanrespondendetail'])->where('kategori_responden', '=', 'alumni')->where('created_at', ">=", $this->from . ' 00:00:00')->where('created_at', "<=", $this->to . ' 23:59:59')->get();
